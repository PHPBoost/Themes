        ...
        # IF C_VISIT_COUNTER #
            <div id="visit-counter" class="hidden-small-screens">
                <div class="visit-counter-total flex-between">
                    ...
                    <span class="pinned small">{VISIT_COUNTER_TOTAL}</span>
                </div>
                <div class="visit-counter-today flex-between">
                    <span class="text-strong">{@date.today}</span>
                    <span class="pinned small">{VISIT_COUNTER_DAY}</span>
                </div>
            </div>
        # ENDIF #
	</div>
...
<script src="{PATH_TO_ROOT}/templates/reverso/js/reverso# IF C_CSS_CACHE_ENABLED #.min# ENDIF #.js"></script>