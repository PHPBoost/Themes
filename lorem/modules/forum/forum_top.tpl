		...
		<div class="module_position forum_top" style="margin-bottom:15px;">
				...
				<div style="padding:10px;">
					<div style="float:left;">
						...
						<div style="margin-top:4px;">
							# IF C_FORUM_CONNEXION #
								...
								<a class="small_link" href="${relative_url(UserUrlBuilder::connect())}"> {L_CONNECT}</a> <span style="color:#000000;">-</span> <a class="small_link" href="${relative_url(UserUrlBuilder::registration())}"> {L_REGISTER}</a>
								# ENDIF #
								# IF C_USER_CONNECTED #
									<a class="small_link" href="?disconnect=true&amp;token={TOKEN}"> {L_DISCONNECT}</a> 
								# ENDIF # 						
							# ENDIF #
							
							# IF C_MODERATION_PANEL #
								# IF C_FORUM_CONNEXION # <span>-</span> # ENDIF #
								<a class="small_link" href="{PATH_TO_ROOT}/forum/moderation_forum.php"> {L_MODERATION_PANEL}</a>
							# ENDIF #
						</div>
					</div>
					<div style="float:right;text-align:right">
						<form action="{PATH_TO_ROOT}/forum/search.php?token={TOKEN}" method="post">
                            <div>
                                <label><input type="text" size="14" id="search" name="search" value="{L_SEARCH}..." class="text" style="color:#FFF;border:2px solid #FFF;border-radius:4px;background:transparent;" onclick="if(this.value=='{L_SEARCH}...')this.value='';" onblur="if(this.value=='')this.value='{L_SEARCH}...';" /></label>
			...
			<div class="forum_links" style="border-top:none;">
				<div style="float:left;">
				<a href="index.php?{SID}">{L_FORUM_INDEX}</a>
				</div>
				# IF C_USER_CONNECTED #
					<div style="float:right;">
						 {U_TOPIC_TRACK} -
						 {U_LAST_MSG_READ} -
						 <span id="nbr_unread_topics">{U_MSG_NOT_READ}</span>
						
						<div style="position:relative;float:left;">
							<div style="position:absolute;z-index:100;float:left;display:none;" id="forum_blockforum_unread">
							</div>
						</div>
