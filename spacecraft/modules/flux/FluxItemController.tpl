<section id="module-flux" class="category-{CATEGORY_ID} single-item">
	<header class="section-header has-thumbnail" style="background-image: linear-gradient(to bottom, rgba(var(--bgc-rgb-m), 0.8), rgba(var(--bgc-rgb-m), 0.8)), url('# IF C_HAS_THUMBNAIL #{U_THUMBNAIL}# ENDIF #')">
        ...
        # IF C_CONTROLS #
            <div class="controls align-right">
                # IF C_EDIT #<a class="offload" href="{U_EDIT}" aria-label="{@common.edit}"><i class="fa fa-edit"></i></a># ENDIF #
                # IF C_DELETE #<a class="offload" href="{U_DELETE}" aria-label="{@common.delete}" data-confirmation="delete-element"><i class="far fa-trash-alt"></i></a># ENDIF #
            </div>
        # ENDIF #
    </header>
