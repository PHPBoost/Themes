...
<footer id="footer">
	...
	<div id="footer-infos" class="content-wrapper" role="contentinfo">
		<span class="footer-infos-powered-by">{@common.powered.by} <i class="fa iboost fa-iboost-logo" aria-hidden="true"></i> <a class="offload" href="https://www.phpboost.com" aria-label="{@common.phpboost.link}">PHPBoost</a></span>
		<span aria-label="{@common.phpboost.right}">| <i class="fab fa-osi" aria-hidden="true"></i> <em class="hidden-large-screens">{@common.phpboost.right}</em></span>
		# IF C_DISPLAY_BENCH #
...
<script src="{PATH_TO_ROOT}/templates/spacecraft/js/spacecraft# IF C_CSS_CACHE_ENABLED #.min# ENDIF #.js"></script>
