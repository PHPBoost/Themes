	...
	<header id="header">
		<img class="entete" src="{PATH_TO_ROOT}/templates/{THEME}/theme/images/header.png" />
		<div id="top-header">
			<!--div id="site-infos">
		...
		<div id="sub-header">
			<div class="sub-deco">
					<div id="sub-header-content">
						<a href="{PATH_TO_ROOT}/news/" title="Accueil du site" >Accueil</a> .:|:. 
						<a href="{PATH_TO_ROOT}/wiki/" title="wiki">Wiki</a> .:|:. 
						<a href="{PATH_TO_ROOT}/articles/" title="Articles" >Articles</a>
					</div>
	...
	<footer id="footer">
		...
		<div class="footer-infos">
			<div id="social">
				<ul>   
					<li><a href="#" target="_blank"><span><div id="fb" class="fade"><i class="fab fa-facebook"></i></div></span></a></li>
