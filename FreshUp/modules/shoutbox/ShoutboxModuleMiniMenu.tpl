...
<form action="#" method="post">
	...
	<p class="shout-spacing">
		...
		<a href="" onclick="shoutbox_refresh_messages_box();return false;" id="shoutbox-refresh" aria-label="${LangLoader::get_message('refresh', 'main')}"><i class="fa fa-refresh"></i></a>
	</p>
</form>
# ELSE #
	...
	# ENDIF #
# ENDIF #
<a class="small" href="${relative_url(ShoutboxUrlBuilder::home())}" aria-label="{@archives.link}">{@archives}</a>
