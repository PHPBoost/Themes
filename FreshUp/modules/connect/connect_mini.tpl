...
<div id="module-connect" class="cell-mini# IF C_VERTICAL # cell-tile cell-mini-vertical# ENDIF ## IF IS_USER_CONNECTED # user-connected# ELSE # user-not-connected# ENDIF #">
	<div class="cell">
		...
		# ELSE # <!-- User Connected -->
			...
			# IF C_VERTICAL #
				<div class="cell-header">
					<h6 class="cell-name">{@user.welcome}</h6>
				</div>
				<div class="cell-list connected-contents">
                    <div class="welcome {USER_LEVEL_CLASS}" # IF C_USER_GROUP_COLOR # style="color:{USER_GROUP_COLOR}"# ENDIF #>
                        {USER_DISPLAYED_NAME}
                        <div class="welcome-avatar">
                            # IF C_USER_AVATAR #
                                <img src="{U_USER_AVATAR}" class="valign-middle" width="122px" height="122px" alt="{USER_DISPLAYED_NAME}">
                            # ELSE #
                                # IF IS_MODERATOR #
