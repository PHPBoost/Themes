# INCLUDE MAINTAIN #
<script src="{PATH_TO_ROOT}/templates/{THEME}/js/toggle.js"></script>
...
<div id="SuperGlobal">
	...
	<footer id="footer">
		...
		<div class="footer-infos">
			...
			# IF C_VISIT_COUNTER #
				<span class="footer-infos-separator">&nbsp;|&nbsp;</span> 
				<span style="font-size: 10px; color:#DDDDDD;">{L_VISIT} : {VISIT_COUNTER_TOTAL} - {L_TODAY} : {VISIT_COUNTER_DAY}</span>
			# ENDIF #
		</div>
	</footer>

	<a id="scroll-to-top" class="scroll-to" href="#"></a>
