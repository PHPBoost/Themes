...
<div id="neck" class="content-wrapper">
    # IF C_MENUS_LEFT_CONTENT # <a href="#" data-menu="menu-left" class="toggle-menu hidden-small-screens" aria-label="{@theme.toggle.menu.left}"><i class="fa fa-arrow-left"></i></a># ENDIF #
    ...
    # IF C_MENUS_RIGHT_CONTENT # <a href="#" data-menu="menu-right" class="toggle-menu hidden-small-screens" aria-label="{@theme.toggle.menu.right}"><i class="fa fa-arrow-right"></i></a># ENDIF #
</div>
