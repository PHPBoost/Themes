	...
	<header id="header">
		<div id="top-header">
			<div class="hidden-min">
				<div id="wellcome"> Bienvenue  sur le site! </div>
				<div id="site-infos">
					<div id="site-logo"><i class="fas fa-sync-alt"></i></div>
				</div>
	...
	<footer id="footer">
		...
		<div class="footer-infos">
			...
			# ENDIF #
			# IF C_VISIT_COUNTER #
			<span>|</span> <span class="text-strong">{L_VISIT} : </span><span>{VISIT_COUNTER_TOTAL} - </span><span class="text-strong">{L_TODAY} : </span><span> {VISIT_COUNTER_DAY}</span>
			# ENDIF #
		</div>
