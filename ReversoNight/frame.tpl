...
<html lang="{L_XML_LANGUAGE}"# IF C_OPENGRAPH # prefix="og: http://ogp.me/ns#"# ENDIF #>
	<head>
		...
		<script type="text/javascript">
				...
				var image = new Array ();
				image[0] = "/theme/images/bg/000.jpg";
				image[1] = "/theme/images/bg/001.jpg";
				image[2] = "/theme/images/bg/002.jpg";
				image[3] = "/theme/images/bg/003.jpg";
				image[4] = "/theme/images/bg/004.jpg";
				image[5] = "/theme/images/bg/005.jpg";

				var hasard = Math.floor(Math.random() * image.length);

				$('#fond-body').css({'background-image': 'url({PATH_TO_ROOT}/templates/ReversoNight' + image[hasard] + ")"});
	...
	<body id="fond-body" itemscope="itemscope" itemtype="http://schema.org/WebPage">
		# INCLUDE BODY #
		# INCLUDE JS_BOTTOM #
	</body>
</html>
