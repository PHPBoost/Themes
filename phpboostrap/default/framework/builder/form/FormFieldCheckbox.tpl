...
<div id="${escape(HTML_ID)}_field" class="form-group col-sm-3# IF C_REQUIRED_AND_HAS_VALUE # constraint-status-right# ENDIF #"# IF C_HIDDEN # style="display:none;"# ENDIF #>
		# IF C_HAS_LABEL #
			<label class="col-sm-10" for="${escape(HTML_ID)}">
				{LABEL}
				# IF C_DESCRIPTION #
		...
		<div id="onblurContainerResponse${escape(HTML_ID)}" class="col-sm-2# IF C_HAS_FORM_FIELD_CLASS # {FORM_FIELD_CLASS}# ENDIF # picture-status-constraint# IF C_REQUIRED # field-required # ENDIF #">
