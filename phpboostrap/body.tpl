	...
	<div id="top-header" class="container-fluid">
		<div class="container">
			<div id="site-infos" class="row">
				<div id="site-name-container" class="# IF C_VISIT_COUNTER #col-sm-10# ELSE #col-sm-12# ENDIF #">
		...
		<div class="col-sm-12 text-center">
			...
			# IF C_DISPLAY_AUTHOR_THEME #
				<small>
					...
					<i class="fa fa-sld-sld sld"></i> <a href="{U_THEME_AUTHOR_LINK}">{L_THEME_AUTHOR}</a>
				</small>
			# ENDIF #
		</div>
