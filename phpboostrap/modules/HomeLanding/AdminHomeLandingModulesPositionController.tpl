			...
			# START modules_list #
				<li class="sortable-element" id="list-{modules_list.ID}" data-id="{modules_list.ID}">
					...
					<div class="sortable-title">
						{modules_list.NAME}
						<div class="pull-right text-right btn-group btn-group-xs">
							# IF C_MORE_THAN_ONE_MODULE #
							<a class="btn btn-primary" href="" title="${LangLoader::get_message('position.move_up', 'common')}" id="move-up-{modules_list.ID}" onclick="return false;"><i class="fa fa-arrow-up"></i></a>
							<a class="btn btn-primary" href="" title="${LangLoader::get_message('position.move_down', 'common')}" id="move-down-{modules_list.ID}" onclick="return false;"><i class="fa fa-arrow-down"></i></a>
							# ENDIF #
							<a class="btn btn-info" href="{modules_list.U_EDIT}" title="${LangLoader::get_message('edit', 'common')}"><i class="fa fa-edit"></i></a>
							<a class="btn # IF modules_list.C_DISPLAY #btn-success# ELSE #btn-danger# ENDIF #" href="" onclick="return false;" id="change-display-{modules_list.ID}"><i # IF modules_list.C_DISPLAY #class="fa fa-eye" title="{@field.display}"# ELSE #class="fa fa-eye-slash" title="{@field.not_display}"# ENDIF #></i></a>
						</div>
					</div>
