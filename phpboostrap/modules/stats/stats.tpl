	<section id="module-stats">
		...
		function XMLHttpRequest_referer(divid)
		{
			if ( document.getElementById('url' + divid).style.display != 'none' )
			{
				...
				document.getElementById('img-url-' + divid).className = 'fa fa-plus-square';
			}
			else
			{
				var xhr_object = null;
				...
				xhr_object.onreadystatechange = function()
				{
					if ( xhr_object.readyState == 4 && xhr_object.status == 200 && xhr_object.responseText != '' )
					{
						...
						document.getElementById('img-url-' + divid).className = 'fa fa-minus-square';
					}
			...
			<div class="table-responsive">
				<table class="table" id="table">
					...
					<tbody>
						...
						<tr>
							<td>
								<a class="fa fa-plus-square" style="cursor: pointer;" onclick="XMLHttpRequest_referer({referer_list.ID})" id="img-url-{referer_list.ID}"></a> <span class="smaller">({referer_list.NBR_LINKS})</span> <a href="{referer_list.URL}">{referer_list.URL}</a>	<span id="load{referer_list.ID}"></span>
							</td>
							<td>
			...
			<div class="table-responsive">
				<table class="table">
					...
					<tbody>
						...
						<tr>
							<td>
								<a class="fa fa-plus-square" style="cursor: pointer;" onclick="XMLHttpRequest_referer({keyword_list.ID})" id="img-url-{keyword_list.ID}"></a> <span class="smaller">({keyword_list.NBR_LINKS})</span> {keyword_list.KEYWORD} <span id="load{keyword_list.ID}"></span>
							</td>
							<td>
