...
<article id="articles" style="order: {ARTICLES_POSITION}; -webkit-order: {ARTICLES_POSITION}; -ms-flex-order: {ARTICLES_POSITION}">
	...
	# START articles_items #
		<div class="module-home">
			...
			<div class="home-cat">
				<a itemprop="about" href="{articles_items.U_CATEGORY}">{articles_items.CATEGORY_NAME}</a>
			</div>

			<a href="{articles_items.U_ARTICLE}" class="picture-link">
			...
			<div class="home-more">
				...
				<span class="float-right"><i class="fa fa-eye" aria-hidden="true"></i> {articles_items.NUMBER_VIEW}</span>
			</div>
			...
			<span class="actions">
				# IF articles_items.C_EDIT #
					<a href="{articles_items.U_EDIT_ARTICLE}" aria-label="${LangLoader::get_message('edit', 'common')}"><i class="fa fa-edit" aria-hidden="true"></i></a>
				# ENDIF #
				# IF articles_items.C_DELETE #
					<a href="{articles_items.U_DELETE_ARTICLE}" aria-label="${LangLoader::get_message('delete', 'common')}" data-confirmation="delete-element"><i class="fa fa-delete" aria-hidden="true"></i></a>
				# ENDIF #
			</span>
			<div class="content">
