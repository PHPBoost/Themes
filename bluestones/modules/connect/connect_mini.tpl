	...
	# IF C_USER_NOTCONNECTED #
		<div id="connect-menu" class="connect-container horizontal-fieldset float-right">
			<div class="connect-top">
				<a href="" onclick="return false" class="connect-button" aria-label="{@connection}"><i class="fa fa-sign-in fa-fw" aria-hidden="true"></i></a>
			</div>
		...
		<div id="connect-menu" class="connect-container horizontal-fieldset float-right">
			<div class="connect-top">
				<a href="" onclick="return false" class="connect-button" aria-label="{@dashboard}">
					# IF IS_ADMIN #<i class="fa fa-user-tie fa-fw" aria-hidden="true"></i># ELSE #<i class="fa fa-user fa-fw" aria-hidden="true"></i># ENDIF #
			...
			<div class="connect-content">
				<i class="close-connect fa fa-window-close fa-fw" aria-hidden="true"></i> <span class="sr-only">${LangLoader::get_message('close', 'main')}</span>
				<ul>
					<li>
						<a href="${relative_url(UserUrlBuilder::home_profile())}">
