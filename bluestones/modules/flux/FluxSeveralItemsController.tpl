							...
							<article id="article-flux-{items.ID}" class="flux-item cell# IF items.C_IS_PARTNER # content-friends# ENDIF ## IF items.C_IS_PRIVILEGED_PARTNER # content-privileged-friends# ENDIF ## IF items.C_NEW_CONTENT # new-content# ENDIF#" itemscope="itemscope" itemtype="https://schema.org/CreativeWork">
										...
										<div class="cell-thumbnail-caption">
											<div class="cell-list">
												<ul>
                                                    ...
                                                    # IF items.C_VISIT #<li class="item-visits-number" aria-label="{@common.visits.number}"> <i class="fa fa-external-link-alt" aria-hidden="true"></i> {items.VISITS_NUMBER}</li># ENDIF #
                                                    # IF C_ENABLED_VIEWS_NUMBER #<li class="item-views-number" aria-label="{@common.views.number}"> <i class="fa fa-eye" aria-hidden="true"></i> {items.VIEWS_NUMBER}</li># ENDIF #
                                                    # IF items.C_CONTROLS #
                                                        <li class="li-stretch">
                                ...
                                <div class="cell-secondary">
                                    <header class="cell-header">
                                        <h2><a class="offload" href="{items.U_ITEM}" itemprop="name">{items.TITLE}</a></h2>
                                    </header>
                                    <div class="cell-body">
