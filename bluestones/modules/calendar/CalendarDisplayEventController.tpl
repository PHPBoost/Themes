<section id="module-calendar">
	...
	<div class="content">
		...
		# ENDIF #
		<article itemscope="itemscope" itemtype="http://schema.org/Event" id="article-calendar-{ID}" class="article-calendar# IF event.C_NEW_CONTENT # new-content# ENDIF #">
			<header>
				<h2>
			...
			<div class="event-display-dates">
				<span class="float-left">{@calendar.labels.start_date} : <time datetime="{START_DATE_ISO8601}" itemprop="startDate"><strong>{START_DATE}</strong></time></span>
				<span class="float-right">{@calendar.labels.end_date} : <time datetime="{END_DATE_ISO8601}" itemprop="endDate"><strong>{END_DATE}</strong></time></span>
			</div>
			<div class="content">
