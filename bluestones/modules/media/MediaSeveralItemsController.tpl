	...
	<div class="sub-section">
		<div class="content-container">
			...
			# ELSE #
				...
				# ENDIF #
				<div class="cell-layout # IF C_GRID_VIEW #cell-flex cell-columns-{ITEMS_NUMBER_PER_ROW}# ELSE #cell-row# ENDIF #">
					# START items #
								...
								<div class="cell-body">
									<div class="cell-thumbnail cell-landscape cell-center">
										...
										<div class="cell-thumbnail-caption">
											<div class="cell-list">
												<ul>
													<li><a href="{items.U_MEDIA_LINK}" aria-label=""><i class="fa fa-share"></i> ${LangLoader::get_message('see.details', 'common')}</a></li>
													<li role="contentinfo" aria-label="${LangLoader::get_message('sort_by.views.number', 'common')}"><i class="fa fa-eye" aria-hidden="true"></i> {items.VIEWS_NUMBER}</li>
													# IF C_ENABLED_COMMENTS #
														<li><i class="fa fa-comments" aria-hidden="true"></i> {items.COMMENTS_NUMBER}</li>
													# ENDIF #
