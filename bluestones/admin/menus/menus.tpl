		...
		<div class="menusmanagement">
			...
			<div id="container-global" class="menus-management-column">
					<div id="container-menu-left" class="menus-management-column-left">
						...
						<div id="mod_left" class="menus-block-list"# IF NOT C_RIGHT_COLUMN # style="background-color: var(--error-tone);"# ENDIF ## IF C_LEFT_COLUMN ## IF C_RIGHT_COLUMN # style=" background-color: var(--error-tone)"# ENDIF ## ENDIF #>
							# START mod_left #
								{mod_left.MENU}
							# END mod_left #
						</div>
				...
				<div id="container-menu-right" class="menus-management-column-right">
					...
					<div id="mod_right" class="menus-block-list"# IF NOT C_LEFT_COLUMN # style=" background-color: var(--error-tone)"# ENDIF ## IF C_RIGHT_COLUMN ## IF C_LEFT_COLUMN # style=" background-color: var(--error-tone)"# ENDIF ## ENDIF #>
						# START mod_right #
							{mod_right.MENU}
						# END mod_right #
					</div>
