...
<header id="header">
	...
	<div id="sub-header">
		...
		<!-- Fin :: Permet de voir les flèches pour cahcher les colonnes de menus -->
...
<div class="clear-scroll"><a id="scroll-to-top" class="scroll-to" href="#" title="${LangLoader::get_message('scroll-to.top', 'user-common')}"><i class="fa fa-chevron-up"></i></a></div>
