...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="{L_XML_LANGUAGE}" >
	<head>
		...
		# ENDIF #
		<link href='http://fonts.googleapis.com/css?family=Molle:400italic|Lobster|Titillium+Web|Archivo+Black|Scada|Ropa+Sans|Allura|Days+One|Kameron|Sirin+Stencil|Aldrich|Viga|Varela|Special+Elite|Andika|Short+Stack|Courgette|Orbitron|Squada+One|Rochester|Geostar|Electrolize|PT+Sans+Caption|Questrial|Smokum|Pinyon+Script|Oswald:400,300,700|Alfa+Slab+One|Fondamento' rel='stylesheet' type='text/css'>
