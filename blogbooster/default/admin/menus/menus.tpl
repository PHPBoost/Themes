						...
						<div id="container-topcentral">
							<div class="container-block">
								<div>
									...
									<p class="menu-block-libelle">
										<span class="form-field-checkbox-mini">
											<input id="top_central_enabled" onclick="minimize_container(this, 'topcentral')" type="checkbox" name="top_central_enabled" disabled="disabled" />
							...
							<div id="mod_topcentral" style="background-color: red;">
