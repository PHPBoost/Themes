...
<!--
	...
	jQuery('#module-connect').swapMini();
	jQuery('#module-mini-countdown').swapMini();
	jQuery('#module-mini-newscat').swapMini();
	jQuery('#module-mini-serverstatus').swapMini();
	jQuery('#module-mini-singlemenu').swapMini();
-->
</script>
