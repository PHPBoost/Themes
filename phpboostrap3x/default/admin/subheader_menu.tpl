	...
	<ul>
		<li class="admin-li">
			...
			<div id="openmodal-{L_ADMINISTRATION}" class="cssmenu-modal">
				...
				<div class="next-menu">
					<a class="pull-left" href="#openmodule-{L_MODULES}" title="{L_MODULES}">
						<i class="fa fa-arrow-left"></i>
						{L_MODULES}
					</a>
					<a class="pull-right" href="#openmodal-{L_TOOLS}" title="{L_TOOLS}">
						{L_TOOLS}
		...
		<li class="admin-li">
			...
			<div id="openmodal-{L_TOOLS}" class="cssmenu-modal">
				<a href="#closemodal" title="${LangLoader::get_message('close_menu', 'admin')}" class="close"><span>x</span></a>
				<div class="next-menu">
					<a class="pull-left" href="#openmodal-{L_ADMINISTRATION}" title="{L_ADMINISTRATION}">
						<i class="fa fa-arrow-left"></i>
						{L_ADMINISTRATION}
					</a>
					<a class="pull-right" href="#openmodal-{L_USER}" title="{L_USER}">
						{L_USER}
						<i class="fa fa-arrow-right"></i>
					</a>
				</div>
		...
		<li class="admin-li">
			...
			<div id="openmodal-{L_USER}" class="cssmenu-modal">
				<a href="#closemodal" title="${LangLoader::get_message('close_menu', 'admin')}" class="close"><span>x</span></a>
				<div class="next-menu">
					<a class="pull-left" href="#openmodal-{L_TOOLS}" title="{L_TOOLS}">
						<i class="fa fa-arrow-left"></i>
						{L_TOOLS}
					</a>
					<a class="pull-right" href="#openmodal-{L_CONTENT}" title="{L_CONTENT}">
						{L_CONTENT}
						<i class="fa fa-arrow-right"></i>
					</a>
				</div>
		...
		<li class="admin-li">
			...
			<div id="openmodal-{L_CONTENT}" class="cssmenu-modal">
				<a href="#closemodal" title="${LangLoader::get_message('close_menu', 'admin')}" class="close"><span>x</span></a>
				<div class="next-menu">
					<a class="pull-left" href="#openmodal-{L_USER}" title="{L_USER}">
						<i class="fa fa-arrow-left"></i>
						{L_USER}
					</a>
					<a class="pull-right" href="#openmodule-{L_MODULES}" title="{L_MODULES}">
						{L_MODULES}
						<i class="fa fa-arrow-right"></i>
					</a>
				</div>
		...
		<li class="admin-li">
			...
			<div id="openmodule-{L_MODULES}" class="cssmenu-modal">
				<a href="#closemodal" title="${LangLoader::get_message('close_menu', 'admin')}" class="close"><span>x</span></a>
				<div class="next-menu">
					<a class="pull-left" href="#openmodal-{L_CONTENT}" title="{L_CONTENT}">
						<i class="fa fa-arrow-left"></i>
						{L_CONTENT}
					</a>
					<a class="pull-right" href="#openmodal-{L_ADMINISTRATION}" title="{L_ADMINISTRATION}">
						{L_ADMINISTRATION}
						<i class="fa fa-arrow-right"></i>
					</a>
				</div>
