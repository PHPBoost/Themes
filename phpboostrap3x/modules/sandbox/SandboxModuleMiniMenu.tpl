	...
	<div id="# IF C_SLIDE_RIGHT #mini-sandbox-right# ELSE #mini-sandbox-left# ENDIF #">
		<a href="" class="sandbox-toggle-btn btn-pbt# IF C_HORIZONTAL # toggle-hor# IF C_SLIDE_RIGHT # toggle-right# ELSE # toggle-left# ENDIF ## ENDIF #" onclick="openSandboxMenu('# IF C_SLIDE_RIGHT #mini-sandbox-right# ELSE #mini-sandbox-left# ENDIF #');return false;">
		...
		<div class="sandbox-menu">
			...
			<div class="sandbox-inset">
				...
				<div class="item-menu panel-pbt">
					<div class="item-title panel-heading">{@mini.tools}</div>
				...
				<div class="item-menu panel-pbt">
					<div class="item-title panel-heading">{@mini.personalization}</div>
				...
				<div class="item-menu panel-pbt">
					<div class="item-title panel-heading">{@mini.sandbox.mod}</div>
