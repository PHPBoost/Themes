		...
		<section id="results">
		   <header>
				<h2>{L_SEARCH_RESULTS}</h2>
				# IF C_SIMPLE_SEARCH #
					<div id="results_choices" class="input-group" style="display:none">
						<span class="input-group-addon">{L_PRINT}</span>
						<select class="form-control" id="results_choice" name="ResultsSelection" onchange="ChangeResults();">
			...
			<div class="row">
				<div class="col-md-12">
					<div id="results_{SEARCH_IN}" class="panel panel-default">
						<div id="results_title_{SEARCH_IN}" class="panel-heading">{L_TITLE_ALL_RESULTS}</div>
						<div id="infos_results_{SEARCH_IN}" class="panel-body">
						...
						<div id="results_list_{SEARCH_IN}" class="pad0">
								{ALL_RESULTS}
						</div>
						<div class="text-center">
							<div id="pagination_results_{SEARCH_IN}" class="pagination"></div>
						</div>
					</div>
					# IF C_SIMPLE_SEARCH #
						# START results #
							<div id="results_{results.MODULE_NAME}" class="panel panel-default" style="display:none">
								<div id="results_title_{results.MODULE_NAME}" class="panel-heading">{results.L_MODULE_NAME}</div>
								<div id="infos_results_{results.MODULE_NAME}" class="panel-body">
									<p class="text-center text-success">
										# IF NB_RESULTS #
											{NB_RESULTS}
										# ENDIF #
								...
								<div id="results_list_{results.MODULE_NAME}"></div>
								<div class="text-center">
									<div id="pagination_results_{results.MODULE_NAME}" class="pagination"></div>
								</div>
							</div>
						# END results #
					# ENDIF #
