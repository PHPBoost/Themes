...
<div id="bbcode-expanded" class="bbcode expand">
	<div class="bbcode-containers btn-toolbar">
		...
		<div class="btn-group btn-group-xs">
			<a class="btn btn-default" href="" onclick="{DISABLED_SMILEYS}bb_display_block('1', '{FIELD}');return false;" onmouseover="{DISABLED_SMILEYS}bb_hide_block('1', '{FIELD}', 1);" onmouseout="bb_hide_block('1', '{FIELD}', 0);" class="bbcode-hover{AUTH_SMILEYS}" title="{@bb_smileys}">
		...
		<div class="btn-group btn-group-xs">
			<span class="btn btn-default">
				<a href="" class="fa fa-fw bbcode-icon-bold{AUTH_B}" onclick="{DISABLED_B}insertbbcode('[b]', '[/b]', '{FIELD}');return false;" title="{@bb_bold}"></a>
			</span>

			<span class="btn btn-default">
				<a href="" class="fa fa-fw bbcode-icon-italic{AUTH_I}" onclick="{DISABLED_I}insertbbcode('[i]', '[/i]', '{FIELD}');return false;" title="{@bb_italic}"></a>
			</span>

			<span class="btn btn-default">
				<a href="" class="fa fa-fw bbcode-icon-underline{AUTH_U}" onclick="{DISABLED_U}insertbbcode('[u]', '[/u]', '{FIELD}');return false;" title="{@bb_underline}"></a>
			</span>

			<span class="btn btn-default">
				<a href="" class="fa fa-fw bbcode-icon-strike{AUTH_S}" onclick="{DISABLED_S}insertbbcode('[s]', '[/s]', '{FIELD}');return false;" title="{@bb_strike}"></a>
			</span>

			<a href="" onclick="{DISABLED_COLOR}bbcode_color('5', '{FIELD}', 'color');bb_display_block('5', '{FIELD}');return false;" onmouseout="{DISABLED_COLOR}bb_hide_block('5', '{FIELD}', 0);" title="{@bb_color}" class="btn btn-default {AUTH_COLOR}">
			...
			<a href="" onclick="{DISABLED_SIZE}bb_display_block('6', '{FIELD}');return false;" onmouseout="{DISABLED_SIZE}bb_hide_block('6', '{FIELD}', 0);" class="btn btn-default bbcode-hover{AUTH_SIZE}" title="{@bb_size}">
			...
			<a href="" onclick="{DISABLED_FONT}bb_display_block('10', '{FIELD}');return false;" onmouseout="{DISABLED_FONT}bb_hide_block('10', '{FIELD}', 0);" class="btn btn-default bbcode-hover{AUTH_FONT}" title="{@bb_font}">
		...
		<div id="bbcode-container-titles" class="btn-group btn-group-xs">
			...
			<a href="" onclick="{DISABLED_TITLE}bb_display_block('2', '{FIELD}');return false;" onmouseout="{DISABLED_TITLE}bb_hide_block('2', '{FIELD}', 0);" class=" btn btn-default bbcode-hover{AUTH_TITLE}" title="{@bb_title}">
			...
			<a href="" onclick="{DISABLED_LIST}bb_display_block('9', '{FIELD}');return false;" onmouseout="{DISABLED_LIST}bb_hide_block('9', '{FIELD}', 0);" class="btn btn-default bbcode-hover{AUTH_LIST}" title="{@bb_list}">
			...
			<div id="bb-block9{FIELD}" class="bbcode-block-container block-list" style="display:none;">
				<div class="bbcode-block bbcode-block-ul" onmouseover="bb_hide_block('9', '{FIELD}', 1);" onmouseout="bb_hide_block('9', '{FIELD}', 0);">
					...
					<div class="input-group">
						<span class="input-group-addon">{@ordered_list}</span>
					...
					<p class="text-center">
						<a class="btn btn-default" href="" onclick="{DISABLED_LIST}bbcode_list('{FIELD}');bb_hide_block('9', '{FIELD}', 0);return false;">
							<i class="fa fa-fw bbcode-icon-list" title="{@bb_list}"></i> {@insert_list}
						</a>
					</p>
				</div>
			</div>
		...
		<div id="bbcode-container-blocks" class="btn-group btn-group-xs">
			<a href="" onclick="{DISABLED_BLOCK}bb_display_block('3', '{FIELD}');return false;" onmouseout="{DISABLED_BLOCK}bb_hide_block('3', '{FIELD}', 0);" class="btn btn-default bbcode-hover{AUTH_BLOCK}" title="{@bb_container}">
			...
			<div id="bb-block3{FIELD}" class="bbcode-block-container" style="display:none;">
				<ul class="bbcode-block bbcode-block-list bbcode-block-block" onmouseover="bb_hide_block('3', '{FIELD}', 1);" onmouseout="bb_hide_block('3', '{FIELD}', 0);">
					<li><a href="" onclick="{DISABLED_B}insertbbcode('[p]', '[/p]', '{FIELD}');bb_hide_block('3', '{FIELD}', 0);return false;" title="{@bb_container} {@bb_paragraph_title}"> {@bb_paragraph} </a></li>
					<li><a href="" onclick="{DISABLED_B}insertbbcode('[block]', '[/block]', '{FIELD}');bb_hide_block('3', '{FIELD}', 0);return false;" title="{@bb_container} {@bb_block_title}"> {@bb_block} </a></li>
			...
			<span class="btn-default">
					<a href="" class="fa fa-fw bbcode-icon-quote{AUTH_QUOTE}" onclick="{DISABLED_QUOTE}insertbbcode('[quote]', '[/quote]', '{FIELD}');return false;" title="{@bb_quote}"></a>
			</span>

			<a href="" onclick="{DISABLED_HIDE}bb_display_block('11', '{FIELD}');return false;" onmouseout="{DISABLED_HIDE}bb_hide_block('11', '{FIELD}', 0);" class="btn btn-default bbcode-hover{AUTH_HIDE}" title="{@bb_hide}">
			...
			<a href="" onclick="{DISABLED_STYLE}bb_display_block('4', '{FIELD}');return false;" onmouseout="{DISABLED_STYLE}bb_hide_block('4', '{FIELD}', 0);" class="btn btn-default bbcode-hover{AUTH_STYLE}" title="{@bb_style}">
		...
		<div id="bbcode-container-links" class="btn-group btn-group-xs">
			<span class="btn btn-default">
				<a href="" class="fa fa-fw bbcode-icon-url{AUTH_URL}" onclick="{DISABLED_URL}bbcode_url('{FIELD}', ${escapejs(L_URL_PROMPT)});return false;" title="{@bb_link}"></a>
			</span>
		</div>

		<div id="bbcode-container-pictures" class="btn-group btn-group-xs">
			<span class="btn btn-default">
				<a href="" class="fa fa-fw bbcode-icon-image{AUTH_IMG}" onclick="{DISABLED_IMG}insertbbcode('[img]', '[/img]', '{FIELD}');return false;" title="{@bb_picture}"></a>
			</span>

			<span class="btn btn-default">
				<a href="" class="fa fa-fw bbcode-icon-lightbox{AUTH_LIGHTBOX}" onclick="{DISABLED_lightbox}bbcode_lightbox('{FIELD}', ${escapejs(@bb_url_prompt)});return false;" title="{@bb_lightbox}"></a>
			</span>
		</div>

		# IF C_UPLOAD_MANAGEMENT #
		<div id="bbcode-container-upload" class="btn-group btn-group-xs">
			<a class="btn btn-default" title="{@bb_upload}" href="#" onclick="window.open('{PATH_TO_ROOT}/user/upload.php?popup=1&amp;fd={FIELD}&amp;edt=BBCode', '', 'height=550,width=769,resizable=yes,scrollbars=yes');return false;">
		...
		<div id="bbcode-container-aligns" class="btn-group btn-group-xs bbcode-container-more">
			<a href="" onclick="{DISABLED_ALIGN}bb_display_block('13', '{FIELD}');return false;" onmouseover="{DISABLED_ALIGN}bb_hide_block('13', '{FIELD}', 1);" onmouseout="bb_hide_block('13', '{FIELD}', 0);" class="btn btn-default bbcode-hover{AUTH_ALIGN}" title="{@bb_align}">
				<i class="fa fa-fw bbcode-icon-left"></i>
			</a>
			...
			<a href="" onclick="{DISABLED_POSITIONS}bb_display_block('14', '{FIELD}');return false;" onmouseover="{DISABLED_POSITIONS}bb_hide_block('14', '{FIELD}', 1);" onmouseout="bb_hide_block('14', '{FIELD}', 0);" class="btn btn-default bbcode-hover{AUTH_POSITIONS}" title="{@bb_positions}">
				<i class="fa fa-fw bbcode-icon-indent"></i>
			</a>
			...
			<a href="" onclick="{DISABLED_TABLE}bb_display_block('7', '{FIELD}');return false;" onmouseover="{DISABLED_TABLE}bb_hide_block('7', '{FIELD}', 1);" class="btn btn-default bbcode-hover{AUTH_TABLE}" title="{@bb_table}">
			...
			<div id="bb-block7{FIELD}" class="bbcode-block-container block-table" style="display:none;">
				<div id="bbtable{FIELD}" class="bbcode-block bbcode-block-table" onmouseover="bb_hide_block('7', '{FIELD}', 1);" onmouseout="bb_hide_block('7', '{FIELD}', 0);">
					...
					<div class="input-group">
						<span class="input-group-addon">{@head_add}</span>
						<span class="input-group-addon">
					...
					<div class="clearfix"></div>
					<p class="text-center">
						<a class="btn btn-default" href="" onclick="{DISABLED_TABLE}bbcode_table('{FIELD}', '{@head_table}');bb_hide_block('7', '{FIELD}', 0);return false;">
		...
		<div id="bbcode-container-exp" class="btn-group btn-group-xs bbcode-container-more">
			<span class="btn btn-default">
				<a href="" class="fa fa-fw bbcode-icon-sup{AUTH_SUP}" onclick="{DISABLED_SUP}insertbbcode('[sup]', '[/sup]', '{FIELD}');return false;" title="{@bb_sup}"></a>
			</span>

			<span class="btn btn-default">
				<a href="" class="fa fa-fw bbcode-icon-sub{AUTH_SUB}" onclick="{DISABLED_SUB}insertbbcode('[sub]', '[/sub]', '{FIELD}');return false;" title="{@bb_sub}"></a>
			</span>

			<a href="" onclick="{DISABLED_BGCOLOR}bbcode_color('15', '{FIELD}', 'bgcolor');bb_display_block('15', '{FIELD}');return false;" onmouseout="{DISABLED_BGCOLOR}bb_hide_block('15', '{FIELD}', 0);" title="{@bb_bgcolor}" class="btn btn-default {AUTH_BGCOLOR}">
				<i class="fa fa-fw bbcode-icon-bgcolor"></i>
			</a>
			<div id="bb-block15{FIELD}" class="bbcode-block-container block-bgcolor-picker" style="display: none;">
				<div id="bb-bgcolor{FIELD}" class="bbcode-block" onmouseover="bb_hide_block('15', '{FIELD}', 1);" onmouseout="bb_hide_block('5', '{FIELD}', 0);">
				</div>
			</div>

			<span class="btn btn-default">
				<a href="" class="fa fa-fw bbcode-icon-anchor{AUTH_ANCHOR}" onclick="{DISABLED_ANCHOR}bbcode_anchor('{FIELD}', ${escapejs(@bb_anchor_prompt)});return false;" title="{@bb_anchor}"></a>
			</span>
		</div>

		<div id="bbcode-container-movies" class="btn-group btn-group-xs bbcode-container-more">
			<span class="btn btn-default">
				<a href="" class="fa fa-fw bbcode-icon-flash{AUTH_SWF}" onclick="{DISABLED_SWF}insertbbcode('[swf=425,344]', '[/swf]', '{FIELD}');return false;" title="{@bb_swf}"></a>
			</span>

			<span class="btn btn-default">
				<a href="" class="fa fa-fw bbcode-icon-movie{AUTH_MOVIE}" onclick="{DISABLED_MOVIE}insertbbcode('[movie=100,100]', '[/movie]', '{FIELD}');return false;" title="{@bb_movie}"></a>
			</span>
			...
			<span class="btn btn-default">
				<a href="" class="fa fa-fw bbcode-icon-sound{AUTH_SOUND}" onclick="{DISABLED_SOUND}insertbbcode('[sound]', '[/sound]', '{FIELD}');return false;" title="{@bb_sound}"></a>
			</span>
		</div>

		<div id="bbcode-container-code" class="btn-group btn-group-xs bbcode-container-more">
			<a href="" onclick="{DISABLED_CODE}bb_display_block('8', '{FIELD}');return false;" onmouseout="{DISABLED_CODE}bb_hide_block('8', '{FIELD}', 0);" class="btn btn-default bbcode-hover{AUTH_CODE}" title="{@bb_code}">
