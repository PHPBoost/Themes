...
<article class="mb15" id="gallery" style="order: {GALLERY_POSITION}; -webkit-order: {GALLERY_POSITION}; -ms-flex-order: {GALLERY_POSITION}">
	<header>
		...
		<div class="col-sm-6 col-md-4" itemscope="itemscope" itemtype="http://schema.org/CreativeWork">
			<div class="thumbnail">
				<a href="{item.U_CATEGORY}">
					...
					<p class="text-center">{item.TITLE} <br /> <i class="fa fa-eye"></i> {item.NB_VIEWS}</p>
				</a>
			</div>
