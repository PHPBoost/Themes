<nav id="cssmenu-onepage" class="navbar navbar-default dropdown-horizontal dropdown-with-submenu" style="order: {ONEPAGE_POSITION}; -webkit-order: {ONEPAGE_POSITION}; -ms-flex-order: {ONEPAGE_POSITION}">
