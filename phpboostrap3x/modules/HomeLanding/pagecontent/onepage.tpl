<nav id="onepage" class="navbar navbar-default dropdown-horizontal dropdown-with-submenu" style="order: {ONEPAGE_POSITION}; -webkit-order: {ONEPAGE_POSITION}; -ms-flex-order: {ONEPAGE_POSITION}">
    <div class="navbar-header">
        <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".onepage-menu">
            <span class="sr-only">${Langloader::get_message('onepage.title', 'common', 'HomeLanding')}</span>
            <i class="fa fa-bars"></i>
        </button>
        <a class="navbar-brand visible-xs" href="#">${Langloader::get_message('onepage.title', 'common', 'HomeLanding')}</a>
    </div>
    <div class="collapse navbar-collapse onepage-menu">
