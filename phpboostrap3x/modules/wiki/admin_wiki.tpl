...
<div id="admin-contents">
    <form action="admin_wiki.php?token={TOKEN}" method="post" class="form-horizontal">
        <fieldset>
            ...
            <div class="fieldset-inset">
                <div class="form-group col-sm-3">
                    <label class="control-label col-sm-12" for="wiki_name">{L_WIKI_NAME}</label>
                    <div class="col-sm-12">
        ...
        <fieldset>
            ...
            <div class="fieldset-inset">
                <div class="form-group col-sm-3">
                    <label class="col-sm-12" for="display_cats">{L_DISPLAY_CATEGORIES_ON_INDEX}</label>
                    <div class="col-sm-12">
                ...
                <div class="form-group col-sm-3">
                    <label class="col-sm-12" for="number_articles_on_index">{L_NUMBER_ARTICLES_ON_INDEX} <span class="help-block">{L_NUMBER_ARTICLES_ON_INDEX_EXPLAIN}</span></label>
                    <div class="col-sm-12">
