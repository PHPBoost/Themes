	...
	function display_new_folder()
	{
		...
		if( !hide_folder )
		{
			document.getElementById('new-folder').innerHTML += '<div class="col-xs-4" id="new-folder' + divid + '"><div class="panel panel-danger"><div class="panel-heading"><input class="form-control" type="text" name="folder_name" id="folder_name" value="" onblur="add_folder(\'{FOLDER_ID}\', \'{USER_ID}\', ' + divid + ');"></div><div class="panel-body text-center"><i class="fa fa-folder fa-2x"></i></div></div></div>';
			document.getElementById('folder_name').focus();
		}
		else
		{
			document.getElementById('new-folder' + (divid - 1)).style.display = 'block';
			document.getElementById('new-folder' + (divid - 1)).innerHTML = '<div class="col-xs-4" id="new-folder' + divid + '"><div class="panel panel-default"><div class="panel-heading"><input class="form-control" type="text" name="folder_name" id="folder_name" value="" onblur="add_folder(\'{FOLDER_ID}\', \'{USER_ID}\', ' + (divid - 1) + ');"></div><div class="panel-body text-center"><i class="fa fa-folder fa-2x"></i></div></div></div>';
			document.getElementById('folder_name').focus();
			this.divid--;
			hide_folder = false;
		}
	...
	<section id="module-user-upload" class="col-sm-12">
							...
							<div class="col-sm-4">
								<div class="panel panel-pbt">
									<div class="panel-heading form-group">
										<span id="f{folder.ID}"><a href="upload.php?f={folder.ID}{POPUP}">{folder.NAME}</a></span>
									</div>
		...
		<footer>
			...
			<fieldset class="fieldset-submit">
				...
				<button class="btn btn-default" type="reset" onclick="javascript:close_popup()" value="true">${LangLoader::get_message('close', 'main')}</button>
				<p></p>
			</fieldset>
			# ENDIF #
		</footer>
