			...
			<header>
				<div class="pull-right text-right">
					<div class="btn-group btn-group-xs">
						# IF C_ACTIV_COM #
							<a href="{U_COM}" class="btn btn-info"><i class="fa fa-comments"></i> {L_COM}</a>&nbsp;
						# ENDIF #
						# IF C_TOOLS_AUTH #
							...
							<a href="{U_DELETE}" title="{L_DELETE}" data-confirmation="delete-element" class="btn btn-danger"><i class="fa fa-trash-alt"></i></a>
						# ENDIF #
						# IF C_PRINT #
