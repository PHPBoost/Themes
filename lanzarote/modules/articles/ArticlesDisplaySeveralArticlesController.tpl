<section>
	...
	# ELSE #
		...
		<div class="spacer">&nbsp;</div>
			# START articles #
				<article # IF C_MOSAIC #class="block"# ENDIF # itemscope="itemscope" itemtype="http://schema.org/CreativeWork">
					<header>
						<h1>
	...
	# IF articles.C_HAS_PICTURE #<img itemprop="thumbnailUrl" src="{articles.PICTURE}" alt="{articles.TITLE}" class="articles"/># ENDIF #
					<div class="content">
