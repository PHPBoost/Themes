			...
			<div class="module-position">
				...
				# START subcats #
							<tr>
								...
								# ELSE #
								<td class="forum-sous-cat-img">
									<img src="{PICTURES_DATA_PATH}/images/{subcats.IMG_ANNOUNCE}.png" alt="{subcats.IMG_ANNOUNCE}" />
								</td>
				...
				<table class="forum-table">
					...
					<tr>
						...
						<td class="forum-sous-cat-img">
							...
							# ELSE #
							<img src="{PICTURES_DATA_PATH}/images/{topics.IMG_ANNOUNCE}.png" alt="{topics.IMG_ANNOUNCE}-hot" />
							# ENDIF #
						</td>
