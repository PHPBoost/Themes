	...
	# ENDIF #
		...
		<div id="links_vertical">
			<div id="links_vertical_top">
				<p style="margin: 0px;">
					<img alt="" src="{PATH_TO_ROOT}/templates/{THEME}/theme/images/top.png" style="cursor: pointer;" onclick="new Effect.ScrollTo('scroll_top_page',{duration:1.2}); return false;">
				</p>
			</div>
			<div id="links_vertical_bottom">
				<p style="margin: 0pt;">
					<img alt="" src="{PATH_TO_ROOT}/templates/{THEME}/theme/images/bottom.png" style="cursor: pointer;" onclick="new Effect.ScrollTo('scroll_bottom_page',{duration:1.2}); return false;">
				</p>
				&nbsp;
			</div>
		</div>
