		...
		<div class="forum_text_column" style="width:350px;margin:auto;height:auto;padding:2px;margin-bottom:20px;color:#333;">
		...
		<div style="margin-top:20px;">
			<div class="module_position">	
				<div class="forum_title_fl">
					<div class="forum_ong_l"></div>		
					<div class="forum_ong_m">
				...
				<div class="forum_ong_r"></div>
				</div>
				<div class="module_contents forum_contents">
					<table class="module_table forum_table_top">
						<tr>
		...
		<div style="margin-top:20px;">
			...
			# IF C_POST_NEW_SUBJECT #
				<div class="forum_title_fl">
					...
					<div class="forum_ong_m">
						<span class="forum_cat_title">
						<a href="{U_POST_NEW_SUBJECT}" title="{L_POST_NEW_SUBJECT}">{L_POST_NEW_SUBJECT}</a>
						</span>
					</div>
					<div class="forum_ong_r"></div>
				</div>
			# ENDIF #
				<div class="forum_title_fr">
					<div class="forum_ong_l"></div>		
					<div class="forum_ong_m">
						<span style="float:right">
					# IF IDCAT #
					<a href="unread.php?cat={IDCAT}" title="{L_DISPLAY_UNREAD_MSG}"><img src="{PICTURES_DATA_PATH}/images/new_mini.png" alt="" class="valign_middle" style="margin-top:-3px"/></a>
					# ENDIF #
					{PAGINATION}
						</span>
					</div>
			...
			<div class="module_contents forum_contents">
				<table class="module_table forum_table_top">
					<tr>
						<td class="forum_text_column" style="min-width:175px;"><a href="${relative_url(SyndicationUrlBuilder::rss('forum',IDCAT))}" title="Rss"><img class="valign_middle" src="{PATH_TO_ROOT}/templates/{THEME}/images/rss.png" alt="Rss" title="Rss" /></a> {U_FORUM_CAT}</td>
		...
		<div class="module_position">
			...
			<div class="module_bottom">
				<span style="float:left;">
					<a href="${relative_url(SyndicationUrlBuilder::rss('forum',IDCAT))}" title="Rss"><img class="valign_middle" src="{PATH_TO_ROOT}/templates/{THEME}/images/rss.png" alt="Rss" title="Rss" /></a> {U_FORUM_CAT}
				</span>
