		...
		# IF C_VERTICAL #
			<div class="module-mini-container color-main">
				<div class="module-mini-top color-03">
					<h5 class="sub-title">{L_SHOUTBOX}</h5>
				</div>
				<div class="module-mini-contents">
					<div id="shout-container">
						# START shout #
						<div id="shout-container-{shout.IDMSG}">
                        	<div class="mess-top"><span>{shout.PSEUDO}</span><span class="mess-date"> {shout.DATE}</span></div>
                            <div class="mess-content"><span>{shout.CONTENTS}</span></div>
                        </div>
						# END shout #
					</div>
					# IF C_VISIBLE_SHOUT #
					...
					<a class="color-03 go-module" href="{PATH_TO_ROOT}/shoutbox/shoutbox.php{SID}" title="">{L_ARCHIVES}</a>
				</div>
				...
				<div class="module-mini-contents" style="width:auto;">
					<div class="shout-horizontal">
						<div id="shout-container">
							...
							<div id="shout-container-{shout.IDMSG}">
							<div class="mess-top"><span>{shout.PSEUDO}</span><span class="mess-date"> {shout.DATE}</span></div>
						    <div class="mess-content">{shout.CONTENTS}</span></div>
						</div>
							# END shout #
						</div>
						# IF C_VISIBLE_SHOUT #
