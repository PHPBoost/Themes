...
<div id="module-connect" class="cell-mini# IF C_VERTICAL # cell-tile cell-mini-vertical# ENDIF ## IF IS_USER_CONNECTED # user-connected# ELSE # user-not-connected# ENDIF #">
	<div class="cell">
		# IF NOT IS_USER_CONNECTED #
			...
			# ELSE #
				<div class="cell-list connect-contents">
					<a href="#" class="js-menu-button" onclick="open_submenu('module-connect', 'active-connect');return false;"><i class="fa fa-sign-in-alt" aria-hidden="true"></i> <span>{@user.welcome} {@user.rank.visitor}</span></a>
			# ENDIF #
				...
				<div class="cell-list connected-contents">
					<a href="#" class="js-menu-button" onclick="open_submenu('module-connect', 'active-connect');return false;">
						...
						# ELSE #
							...
							# ENDIF #
						# ENDIF #
						<span aria-label="{@user.my.profile}" class="{USER_LEVEL_CLASS}" # IF C_USER_GROUP_COLOR # style="color:{USER_GROUP_COLOR}"# ENDIF #>{@user.welcome} {USER_DISPLAYED_NAME}</span>
						# IF C_HAS_PM #
