	...
	<div id="connect-menu">
		<div class="horizontal-fieldset">
			<a href="" class="js-menu-button" onclick="open_submenu('connect-menu');return false;" title="{L_PROFIL}">
				<i class="fa fa-user# IF C_HAS_PM # blink# ENDIF ## IF C_UNREAD_ALERT # blink# ENDIF ## IF C_UNREAD_CONTRIBUTION # blink# ENDIF #"></i>
				{PSEUDO}
			</a>
					
			<ul class="connect-content">
				<img src="{U_AVATAR_IMG}" alt="{PSEUDO}" title="{PSEUDO}" />
				<li>
					<i class="fa fa-user"></i>
					<a href="${relative_url(UserUrlBuilder::home_profile())}" class="small"> {L_PRIVATE_PROFIL}</a>
				</li>
