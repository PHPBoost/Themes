			<section id="module-calendar-events">
				...
				<div class="elements-container columns-2">
					# START event #
					<article id="article-calendar-{event.ID}" class="article-calendar article-several block# IF event.C_NEW_CONTENT # new-content# ENDIF #" itemscope="itemscope" itemtype="http://schema.org/Event">
						<header>
							<h2>
