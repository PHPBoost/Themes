	...
	<div class="module-mini-container">
		...
		<div class="module-mini-contents">
			<div id="mini-search-form" class="input-element-button">
				...
				<button type="submit" name="search_submit"><i class="fa fa-search fa-2x"></i></button>
				<a href="{U_ADVANCED_SEARCH}" class="small advanced"><i class="fa fa-plus-square fa-3x" title="{L_ADVANCED_SEARCH}"></i></a>
			</div>
		</div>
