		...
		<section>
			...
			<div class="content">
				# IF C_DESCRIPTION #
					<div itemprop="text">{DESCRIPTION}</div>
								...
								# IF file.C_IMG #
									<div class="float-right">
										<a href="{file.U_DOWNLOAD_LINK}">
											<img class="dl-mini" src="{file.IMG}" alt="{file.IMG_NAME}" itemprop="image" />
										</a>
									</div>
								# ENDIF #
		...
		<article itemscope="itemscope" itemtype="http://schema.org/CreativeWork">
			...
			<div class="content">
				<div class="options infos">
					<div class="center">
						# IF C_IMG #
							<img class="dl-mini" src="{U_IMG}" alt="{IMAGE_ALT}" itemprop="image"/>
							<br /><br />
						# ENDIF #
