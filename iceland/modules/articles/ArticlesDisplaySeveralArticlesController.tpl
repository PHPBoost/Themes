<section>
	...
	# ELSE #
		...
		<div class="spacer">&nbsp;</div>
			# START articles #
				<article class="# IF C_MOSAIC #medium-block mozaic# ELSE #liste# ENDIF #" itemscope="itemscope" itemtype="http://schema.org/CreativeWork">
					<header>
						<h1>
					...
					<div class="content">
						# IF articles.C_HAS_PICTURE #<a itemprop="url" href="{articles.U_ARTICLE}"><img itemprop="thumbnailUrl" src="{articles.PICTURE}" alt="{articles.TITLE}" /></a># ENDIF #
