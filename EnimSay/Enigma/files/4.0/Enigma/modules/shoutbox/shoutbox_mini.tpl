		...
		# ELSE #
			<div class="module_mini_container" style="width:auto; margin:0px 0px 0px 4px; padding:0px;">
				<div class="main_top_l"></div>
				<div class="main_top_r"></div>
				<div class="main_top">
					<h5 class="sub_title" style="padding-top:10px;text-align:center;">{L_SHOUTBOX}</h5>
				</div>
				<div class="main_content_borderl">
				<div class="main_content_borderr">
				<div class="main_content_border" style="text-align:center;padding:0px 10px;">
