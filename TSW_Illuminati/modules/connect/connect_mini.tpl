...
# ELSE #
	...
	<div id="connect-menu" class="connected">
			<a href="" class="js-menu-button" onclick="open_submenu('connect-menu');return false;" title="{L_PRIVATE_PROFIL}"><i class="fa fa-bars # IF NUMBER_TOTAL_ALERT # blink alert# ENDIF #"></i> <span>{L_PRIVATE_PROFIL}</span></a>
			<ul class="connect-content">
				<li>
					<i class="fa fa-profil"></i>
					<a href="${relative_url(UserUrlBuilder::home_profile())}" class="small" title="{L_PROFIL}"> {L_PROFIL}</a>
				</li>
				<li>
					<i class="fa fa-envelope# IF C_HAS_PM # blink# ENDIF #"></i>
					<a href="{U_USER_PM}" class="small"> {L_NBR_PM}</a>
