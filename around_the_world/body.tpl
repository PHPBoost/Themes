...
<header id="header">
	<div id="top-header">
		# IF C_MENUS_TOP_HEADER_CONTENT #
			<div id="top-header-content" class="content-wrapper duotone">
                <div class="diagonal">
	...
	<div id="sub-header">
		# IF C_MENUS_SUB_HEADER_CONTENT #
			<div id="sub-header-content" class="content-wrapper duotone">
                <div class="diagonal">
...
<main id="global" class="content-preloader" role="main">
    <div id="slideshow" class="content-wrapper">
        <a href="{PATH_TO_ROOT}/"><img src="{PATH_TO_ROOT}/templates/{THEME}/theme/images/slide/1.webp"/></a>
        <a href="{PATH_TO_ROOT}/"><img src="{PATH_TO_ROOT}/templates/{THEME}/theme/images/slide/2.webp"/></a>
        <a href="{PATH_TO_ROOT}/"><img src="{PATH_TO_ROOT}/templates/{THEME}/theme/images/slide/3.webp"/></a>
        <a href="{PATH_TO_ROOT}/"><img src="{PATH_TO_ROOT}/templates/{THEME}/theme/images/slide/4.webp"/></a>
        <a href="{PATH_TO_ROOT}/"><img src="{PATH_TO_ROOT}/templates/{THEME}/theme/images/slide/5.webp"/></a>
    </div>
