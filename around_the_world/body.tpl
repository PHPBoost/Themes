	# INCLUDE MAINTAIN #
    <div id="header-gsm"><img src="{PATH_TO_ROOT}/templates/{THEME}/theme/images/header.png"/></div>	
	<header id="header">
		<div id="top-header">
			<!--div id="site-infos">
		...
		<div id="slideshow">
			<div><img src="{PATH_TO_ROOT}/templates/{THEME}/theme/images/slide/1.png"/></div>
			<div><img src="{PATH_TO_ROOT}/templates/{THEME}/theme/images/slide/2.png"/></div>
			<div><img src="{PATH_TO_ROOT}/templates/{THEME}/theme/images/slide/3.png"/></div>
			<div><img src="{PATH_TO_ROOT}/templates/{THEME}/theme/images/slide/4.png"/></div>
			<div><img src="{PATH_TO_ROOT}/templates/{THEME}/theme/images/slide/5.png"/></div>
		</div>
		<div class="spacer"></div>
	</header>
