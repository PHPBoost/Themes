<section id="module-download">
	...
	# IF C_FILES #
		...
		# ELSE #
			# START downloadfiles #
			<article id="article-download-{downloadfiles.ID}" class="article-download article-several# IF C_CATEGORY_DISPLAYED_SUMMARY # small-block# ENDIF #" itemscope="itemscope" itemtype="http://schema.org/CreativeWork">
