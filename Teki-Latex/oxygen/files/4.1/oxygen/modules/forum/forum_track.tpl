						...
						<tbody>
							...
							<tr>
								<td class="forum-sous-cat-img">
									...
									<img src="{PICTURES_DATA_PATH}/images/{topics.IMG_ANNOUNCE}.png" alt="{topics.IMG_ANNOUNCE}" />
									# ELSE #
									<img src="{PICTURES_DATA_PATH}/images/{topics.IMG_ANNOUNCE}-hot.png" alt="{topics.IMG_ANNOUNCE}-hot" />
									# ENDIF #
								</td>
								...
								<td class="forum-sous-cat-compteur" style="width:40px;">
									<input type="checkbox" id="p{topics.INCR}" name="p{topics.ID}" {topics.CHECKED_PM}>
								</td>
								<td class="forum-sous-cat-compteur" style="width:50px;">
									<input type="checkbox" id="m{topics.INCR}" name="m{topics.ID}" {topics.CHECKED_MAIL}>
								</td>
								<td class="forum-sous-cat-compteur" style="width:85px;">
