	...
	<div id="connect-menu" class="connected">
		<div class="horizontal-fieldset">
			...
			<ul class="connect-content">
				...
				--><li>
					<a href="{U_USER_PM}" class="small" title="{L_NBR_PM}"><i class="fa fa-envelope# IF C_HAS_PM # blink# ENDIF #"></i> <span class="user-span">{L_NBR_PM}</span></a>
				</li><!--
				# IF C_ADMIN_AUTH #
				--><li>
					<a href="${relative_url(UserUrlBuilder::administration())}" class="small" title="{L_ADMIN_PANEL}# IF C_UNREAD_ALERT # ({NUMBER_UNREAD_ALERTS})# ENDIF #"><i class="fa fa-wrench# IF C_UNREAD_ALERT # blink# ENDIF #"></i> <span class="user-span">{L_ADMIN_PANEL}# IF C_UNREAD_ALERT # ({NUMBER_UNREAD_ALERTS})# ENDIF #</span></a>
				</li><!--
				# ENDIF #
				# IF C_MODERATOR_AUTH #
				--><li>
					<a href="${relative_url(UserUrlBuilder::moderation_panel())}" class="small" title="{L_MODO_PANEL}"><i class="fa fa-legal"></i> <span class="user-span">{L_MODO_PANEL}</span></a>
				</li><!--
				# ENDIF #
				--><li>
