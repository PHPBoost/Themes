			...
			# ENDIF #
					<ul class="connect-container# IF C_HORIZONTAL # connect-container-horizontal# ENDIF #">
						...
						<li class="li-stretch connect-pm">
							<a href="{U_USER_PM}" class="offload" aria-label="{@user.private.messaging}">
						...
						# IF IS_ADMIN #
							<li class="li-stretch connect-admin">
								<a href="${relative_url(UserUrlBuilder::administration())}" class="offload" aria-label="{@user.admin.panel}">
						...
						<li class="li-stretch connect-contribution">
							<a href="${relative_url(UserUrlBuilder::contribution_panel())}" class="offload" aria-label="{@user.contribution.panel}">
						...
						# START additional_menus #
							# IF additional_menus.C_DISPLAY #
								<li class="li-stretch connect-{additional_menus.MENU_NAME}">
									<a href="{additional_menus.URL}" class="offload" aria-label="{additional_menus.LABEL}">
