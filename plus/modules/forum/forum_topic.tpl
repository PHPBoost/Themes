					...
					<span class="float-right">
						...
						# ENDIF #
                             ...
                             <div id="forum-topic-name">
                                <a itemscope="name" title="{TITLE_T}" href="{U_TITLE_T}"><span id="display_msg_title">{DISPLAY_MSG}</span>{TITLE_T}</a> <span class="desc-forum">{DESC}</span>
                            </div>
						    ...
						    <div class="msg-avatar-mbr # IF msg.C_USER_ONLINE # online # ELSE # offline # ENDIF # center">
                                                    ...
                                                    <div class="msg-top-row">
                                                        ...
                                                        # IF msg.C_FORUM_USER_LOGIN # 
                                                         <a title="{msg.FORUM_USER_LOGIN}" class="msg-link-pseudo" href="{msg.U_FORUM_USER_PROFILE}">{msg.FORUM_USER_LOGIN}</a>
                                                        # ELSE # 
                                                                <em>{L_GUEST}</em>
                                                        # ENDIF #
                                                         - <a href="topic{msg.U_VARS_ANCRE}#m{msg.ID}" title="{msg.FORUM_MSG_DATE}"><i class="fa fa-clock-o"></i></a> {msg.FORUM_MSG_DATE}
