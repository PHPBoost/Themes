		...
		<article itemscope="itemscope" itemtype="http://schema.org/Creativework" id="article-forum-{ID}" class="forum-contents">
			<header>
				<h2>
					<a href="${relative_url(SyndicationUrlBuilder::rss('forum',ID))}" aria-label="${LangLoader::get_message('syndication', 'common')}" class="syndication-container"><i class="fa fa-syndication" aria-hidden="true" title="${LangLoader::get_message('syndication', 'common')}"></i></a>
					<a href="./index.php" title="Index"><i class="fa fa-globe"></i></a> <i class="fa fa-angle-double-right" aria-hidden="true"></i> {U_FORUM_CAT}
				...
				<div class="msg-position" id="d{msg.ID}">
					<div class="msg-container{msg.CLASS_COLOR}">
						...
						<div class="msg-top bkgd-color-op20-sc">
							<div class="msg-avatar-mbr # IF msg.C_USER_ONLINE # online # ELSE # offline # ENDIF # center">
							...
							<div class="msg-top-row">
								<div class="msg-pseudo-mbr bkgd-color-op20">
									...
									<em>{L_GUEST}</em>
									# ENDIF #
									- <a href="topic{msg.U_VARS_ANCRE}#m{msg.ID}" aria-label="{msg.TOPIC_DATE_FULL}"><i class="fa fa-clock" aria-hidden="true" title="{msg.TOPIC_DATE_FULL}"></i></a> ${LangLoader::get_message('on', 'main')} {msg.TOPIC_DATE_FULL}
									<div class="member-infos">
										# IF msg.C_USER_RANK #
										<p class="center">{msg.USER_RANK}</p># ELSE #<p class="center">${LangLoader::get_message('banned', 'user-common')}</p>
										# ENDIF #
										# IF msg.C_USER_IMG_ASSOC #
										<p class="center"><img src="{msg.USER_IMG_ASSOC}" alt="${LangLoader::get_message('rank', 'main')}" title="${LangLoader::get_message('rank', 'main')}" /></p>
										# ENDIF #
							...
							<div class="msg-top-right">
								# IF C_AUTH_POST #
								<a href="topic{msg.U_VARS_QUOTE}#go-bottom" aria-label="{L_QUOTE}"><i class="fa fa-quote-right" aria-hidden="true" title="{L_QUOTE}"></i></a># ENDIF #
								...
								<a href="move{msg.U_FORUM_MSG_CUT}" aria-label="{L_CUT_TOPIC}" data-confirmation="{L_ALERT_CUT_TOPIC}"><i class="fa fa-cut" aria-hidden="true" title="{L_CUT_TOPIC}"></i></a>
								# ENDIF #
