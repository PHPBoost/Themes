	...
	<div class="forum-links">
			...
			<ul>
				<li>
					<span class="cssmenu-title">
						<a href="index.php" aria-label="{L_FORUM_INDEX}"><i class="fa fa-home" aria-hidden="true" title="{L_FORUM_INDEX}"></i> <span>{L_FORUM_INDEX}</span></a>
					</span>
				</li>
				<li>
					<span class="cssmenu-title">
						<a href="{U_SHOW_MY_MSG}" aria-label="{L_SHOW_MY_MSG}"><i class="fa fa-showmymsg" aria-hidden="true" title="{L_SHOW_MY_MSG}"></i> <span>{L_SHOW_MY_MSG}</span></a>
					</span>
				</li>
				<li>
					<span class="cssmenu-title">
						<a href="{U_TOPIC_TRACK}" aria-label="{L_SHOW_TOPIC_TRACK}"><i class="fa fa-msg-track" aria-hidden="true" title="{L_SHOW_TOPIC_TRACK}"></i> <span>{L_SHOW_TOPIC_TRACK}</span></a>
					</span>
				</li>
				<li class="forum-index">
					<span class="cssmenu-title">
						<a href="{U_LAST_MSG_READ}" aria-label="{L_SHOW_LAST_READ}"><i class="fa fa-lastview" aria-hidden="true" title="{L_SHOW_LAST_READ}"></i> <span>{L_SHOW_LAST_READ}</span></a>
					</span>
				</li>
				<li>
					<span class="cssmenu-title">
						<a href="{U_MSG_NOT_READ}" aria-label="{L_SHOW_NOT_READS}"><i class="fa fa-notread" aria-hidden="true" title="{L_SHOW_NOT_READS}"></i> <span>{L_SHOW_NOT_READS}</span> <span id="nbr_unread_topics_bottom">{NBR_MSG_NOT_READ}</span></a>
				...
				<li>
					<span class="cssmenu-title">
						<a href="{U_MSG_SET_VIEW}" aria-label="{L_MARK_AS_READ}" onclick="javascript:return Confirm_read_topics();"><i class="fa fa-eraser" aria-hidden="true" title="{L_MARK_AS_READ}"></i> <span>{L_MARK_AS_READ}</span></a>
					</span>
				</li>
				# IF C_FORUM_CONNEXION #
				<li>
					<span class="cssmenu-title">
						<a href="${relative_url(UserUrlBuilder::disconnect())}" aria-label="{L_DISCONNECT}"><i class="fa fa-sign-out" aria-hidden="true" title="{L_DISCONNECT}"></i> <span>{L_DISCONNECT}</span></a>
					</span>
				</li>
				# ENDIF #
			</ul>
		...
		<nav class="cssmenu cssmenu-group float-right" id="cssmenu-sign-in-bottom-link">
			<ul>
				<li>
					<span class="cssmenu-title">
						<a href="${relative_url(UserUrlBuilder::connect())}" aria-label="{L_CONNECT}"><i class="fa fa-sign-in" aria-hidden="true" title="{L_CONNECT}"></i> <span>{L_CONNECT}</span></a>
					</span>
				</li>
				<li>
					<span class="cssmenu-title">
						<a href="${relative_url(UserUrlBuilder::registration())}" aria-label="{L_REGISTER}"><i class="fa fa-ticket" aria-hidden="true" title="{L_REGISTER}"></i> <span>{L_REGISTER}</span></a>
					</span>
				</li>
			</ul>
		</nav>
