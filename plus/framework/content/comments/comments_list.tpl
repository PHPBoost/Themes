			...
			<div class="message-date">
				<span class="message-pseudo">
					# IF comments.C_VISITOR #
						<span itemprop="author" title="{comments.L_LEVEL}">{comments.PSEUDO}</span>
					# ELSE #
						<a itemprop="author" href="{comments.U_PROFILE}" class="{comments.LEVEL_CLASS}" # IF comments.C_GROUP_COLOR # style="color:{comments.GROUP_COLOR}" # ENDIF # title="{comments.L_LEVEL}">
							{comments.PSEUDO}
						</a>
					# ENDIF #
				</span>
