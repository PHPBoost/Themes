...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="{L_XML_LANGUAGE}" >
	<head>
		...
		/templates/{THEME}/theme/menu_header.css;
		...
		<link rel="stylesheet" href="{PATH_TO_ROOT}/templates/{THEME}/theme/menu_header.css" type="text/css" media="screen, print, handheld" />
...
<div id="global">
	...
	<!-- Commencement du menu de navigation principal du site --> 
	<div id='cssmenu'>
		<ul>
			<li class='active'><a href='{PATH_TO_ROOT}/'><span>Accueil</span></a>
			<li><a href='#'><span>Navigation</span></a></li>
			<li class="active"></li>
			<li class="has-sub">
			...
			<li><a href='#'><span>Navigation</span></a></li>
			<li class="active"></li>
			<li class="has-sub"><a href="#"><span>Navigation</span></a>
				<ul>
					<li><a href="#"><span>Navigation</span></a></li>
					<li><a href="#"><span>Navigation</span></a></li>
					<li><a href="#"><span>Navigation</span></a></li>
	...
	<!-- Fin du menu de navigation principal du site --> 
