		...
		<div class="horizontal-fieldset horizontal-fieldset-top">
			...
			<ul class="connect-content">
				<li>
					...
					<a href="${relative_url(UserUrlBuilder::home_profile())}"><i class="fa fa-user"></i></a>
				</li>
				<li>
					
					<a href="{U_USER_PM}"><i class="fa fa-envelope# IF C_HAS_PM # blink# ENDIF #"></i></a>
				</li>
				# IF C_ADMIN_AUTH #
				<li>
					
					<a href="${relative_url(UserUrlBuilder::administration())}"><i class="fa fa-wrench# IF C_UNREAD_ALERT # blink# ENDIF #"></i># IF C_UNREAD_ALERT # ({NUMBER_UNREAD_ALERTS})# ENDIF #</a>
				</li>
				# ENDIF #
				# IF C_MODERATOR_AUTH #
				<li>
					
					<a href="${relative_url(UserUrlBuilder::moderation_panel())}"><i class="fa fa-legal"></i></a>
				</li>
				# ENDIF #
				<li>
					
					<a href="${relative_url(UserUrlBuilder::contribution_panel())}"><i class="fa fa-file-text# IF C_UNREAD_CONTRIBUTION # blink# ENDIF #"></i># IF C_KNOWN_NUMBER_OF_UNREAD_CONTRIBUTION # ({NUMBER_UNREAD_CONTRIBUTIONS})# ENDIF #</a>
				</li>
				<li>
					
					<a href="${relative_url(UserUrlBuilder::disconnect())}"><i class="fa fa-sign-out"></i></a>
				</li>
			</ul>
		</div>
	</div>
