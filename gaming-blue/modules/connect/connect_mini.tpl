			...
			<ul class="connect-elements-container">
				<li class="connect-element connect-profil">
					<a href="${relative_url(UserUrlBuilder::home_profile())}" class="small">
						<i class="fa fa-profil"></i><span class="masqued">{@dashboard}</span>
					</a>
				</li>
				<li class="connect-element connect-pm# IF C_HAS_PM # connect-event# ENDIF #">
					<a href="{U_USER_PM}" class="small">
						<i class="fa fa-envelope# IF C_HAS_PM # blink# ENDIF #"></i><span class="masqued">{L_PM_PANEL}</span># IF C_HAS_PM #<span class="masqued blink">({NUMBER_PM})</span># ENDIF #
					</a>
				</li>
				# IF C_ADMIN_AUTH #
				<li class="connect-element connect-admin# IF C_UNREAD_ALERT # connect-event# ENDIF #">
					<a href="${relative_url(UserUrlBuilder::administration())}" class="small">
						<i class="fa fa-wrench# IF C_UNREAD_ALERT # blink# ENDIF #"></i><span class="masqued">{L_ADMIN_PANEL}</span># IF C_UNREAD_ALERT #<span class="masqued blink">({NUMBER_UNREAD_ALERTS})</span># ENDIF #
					</a>
				</li>
				# ENDIF #
				# IF C_MODERATOR_AUTH #
				<li class="connect-element connect-modo">
					<a href="${relative_url(UserUrlBuilder::moderation_panel())}" class="small">
						<i class="fa fa-legal"></i><span class="masqued">{L_MODO_PANEL}</span>
					</a>
				</li>
				# ENDIF #
				<li class="connect-element connect-contribution# IF C_UNREAD_CONTRIBUTION # connect-event# ENDIF #">
					<a href="${relative_url(UserUrlBuilder::contribution_panel())}" class="small">
						<i class="fa fa-file-text# IF C_UNREAD_CONTRIBUTION # blink# ENDIF #"></i><span class="masqued">{L_CONTRIBUTION_PANEL}</span># IF C_UNREAD_CONTRIBUTION #<span class="masqued blink">({NUMBER_UNREAD_CONTRIBUTIONS})</span># ENDIF #
					</a>
				</li>
				<li class="connect-element connect-disconnect">
					<a href="${relative_url(UserUrlBuilder::disconnect())}" class="small">
						<i class="fa fa-sign-out"></i><span class="masqued">{@disconnect}</span>
					</a>
				</li>
			</ul>
		</div>
