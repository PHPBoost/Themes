<section id="module-news">
	...
	<div class="content">
		...
		<article itemscope="itemscope" itemtype="http://schema.org/CreativeWork" id="article-news-{ID}" class="article-news# IF C_NEW_CONTENT # new-content# ENDIF #">
			<header>
				<h2>
					<a href="{U_SYNDICATION}" title="${LangLoader::get_message('syndication', 'common')}"><img src="{PATH_TO_ROOT}/templates/{THEME}/images/rss.png"></a> <span itemprop="name">{NAME}</span>
					<span class="actions">
						# IF C_EDIT #
