<ul>
	<li>
		...
		<ul>
			...
			<li><a href="${relative_url(UserUrlBuilder::disconnect())}"><img src="{PATH_TO_ROOT}/templates/{THEME}/images/admin/home_mini.png"/> {L_DISCONNECT}</a></li>
			# IF C_ADMIN_LINKS_1 #
			<li class="separator"></li>
				# START admin_links_1 #
	...
	<li>
		...
		<ul>
			...
			<li><a href="${relative_url(AdminMaintainUrlBuilder::maintain())}"><img src="{PATH_TO_ROOT}/templates/{THEME}/images/admin/maintain_mini.png"/> {L_MAINTAIN}</a></li>
			<li class="extend">
	...
	<li>
		<h5 class="links"><img src="{PATH_TO_ROOT}/templates/{THEME}/images/admin/tools_mini.png" class="valign-middle" alt="" /> {L_TOOLS}</h5>
		<ul>
			<li class="extend">
			...
			<li class="extend">
				...
				<a href="${relative_url(AdminServerUrlBuilder::system_report())}"><img src="{PATH_TO_ROOT}/templates/{THEME}/images/admin/server_mini.png"/> {L_SERVER}</a>
				<ul>
	...
	<li>
		<h5 class="links"><img src="{PATH_TO_ROOT}/templates/{THEME}/images/admin/groups_mini.png" class="valign-middle" alt="" /> {L_USER}</h5>
		<ul>
			<li class="extend">
			...
			<li class="extend">
				<a href="${relative_url(AdminExtendedFieldsUrlBuilder::fields_list())}"><img src="{PATH_TO_ROOT}/templates/{THEME}/images/admin/extendfield_mini.png"/> {L_EXTEND_FIELD}</a>
				<ul>
	...
	<li>
		<h5 class="links"><img src="{PATH_TO_ROOT}/templates/{THEME}/images/admin/contents_mini.png" class="valign-middle" alt="" /> {L_CONTENT}</h5>
		<ul>
			...
			<li class="extend">
				<a href="${relative_url(UserUrlBuilder::comments())}"><img src="{PATH_TO_ROOT}/templates/{THEME}/images/admin/com_mini.png"/> {L_COMMENTS}</a>
				<ul>
			...
			<li class="extend">
				<a href="${relative_url(AdminSmileysUrlBuilder::management())}"><img src="{PATH_TO_ROOT}/templates/{THEME}/images/admin/smileys_mini.png"/> {L_SMILEY}</a>
				<ul>
	...
	<li>
		<h5 class="links"><img src="{PATH_TO_ROOT}/templates/{THEME}/images/admin/modules_mini.png" class="valign-middle" alt="" /> {L_MODULES}</h5>
		<ul>
			<li class="extend">
