			...
			# START articles #
				<article # IF C_MOSAIC #class="small-block"# ENDIF # itemscope="itemscope" itemtype="http://schema.org/CreativeWork">
					...
					<p class="date-bandeau">
						<time datetime="{articles.DATE_ISO8601}" itemprop="datePublished">{articles.DATE_SHORT}</time>
					</p>
					# IF articles.C_HAS_PICTURE #
					<img itemprop="thumbnailUrl" src="{articles.PICTURE}" alt="{articles.TITLE}" class="article-img"/>
					# ELSE #
